      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="md:flex md:items-center md:justify-between">
          ...
          <div className="mt-8 md:mt-0 md:order-1">
            <p className="text-center text-base text-gray-500">&copy; {currentYear} CollectorsHub. All rights reserved.</p>
          </div>
        </div>
        <div className="mt-8 text-center">
            <a href="/about" className="text-sm text-gray-500 hover:text-gray-900 mx-4">About</a>
